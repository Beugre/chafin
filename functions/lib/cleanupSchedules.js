...
exports.recalculateAllSchedules = exports.regenerateSchedules = exports.cleanupMalformedSchedules = void 0;
 ...
 */
exports.cleanupMalformedSchedules = functions
    .region("us-central1")
 ...
 */
exports.regenerateSchedules = functions
    .region("us-central1")
    .https.onRequest(async (req, res) => {
    try {
        ...
        for (const loanDoc of loansSnapshot.docs) {
            try {
                ...
                if (existingSchedules.size >= expectedScheduleCount) {
                    console.log(`✅ Prêt ${loanId}: ${existingSchedules.size}/${expectedScheduleCount} schedules OK`);
                    continue;
                }
                console.log(`⚠️ Prêt ${loanId}: seulement ${existingSchedules.size}/${expectedScheduleCount} schedules, régénération...`);
 ...
 */
function generateScheduleForLoan(loan, loanId) {
    const schedule = [];
    ...
    for (let i = 1; i <= dureeMois; i++) {
        ...
        const scheduleItem = {
            ...
            loanId: loanId,
            numero: i,
            dueDate: firestore_2.Timestamp.fromDate(dueDate),
            principal: principal,
            interet: interet,
            total: total,
            isPaid: false,
 ...
 */
exports.recalculateAllSchedules = functions
    .region("us-central1")
    .https.onRequest(async (req, res) => {
    try {
...
//# sourceMappingURL=cleanupSchedules.js.map